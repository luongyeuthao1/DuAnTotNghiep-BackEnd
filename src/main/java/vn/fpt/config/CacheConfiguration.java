...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, vn.fpt.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, vn.fpt.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, vn.fpt.domain.User.class.getName());
