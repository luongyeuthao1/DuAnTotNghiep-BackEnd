...
export class NotificationsComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.notificationsService
      ...
      .subscribe(
        (res: HttpResponse<INotifications[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInNotifications(): void {
    this.eventSubscriber = this.eventManager.subscribe('notificationsListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: INotifications[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
